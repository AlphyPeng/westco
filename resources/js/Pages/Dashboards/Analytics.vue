    ...
    <div class="mb-3 card">
      ...
      <div class="row g-0">
        ...
        <div class="col-sm-12 col-md-4 col-xl-4">
          <DashboardWidget stat-key="capitalGains" icon-class="pe-7s-musiclist" icon-bg-class="bg-success"
                      ...
                      <div class="widget-content-left me-2">
                        <div class="form-check">
                          <input type="checkbox" id="exampleCustomCheckbox12" class="form-check-input" /><label
                            class="form-check-label" for="exampleCustomCheckbox12">&nbsp;</label>
                        </div>
                      </div>
                      <div class="widget-content-left">
                      ...
                      <div class="widget-content-left me-2">
                        <div class="form-check">
                          <input type="checkbox" id="exampleCustomCheckbox1" class="form-check-input" /><label
                            class="form-check-label" for="exampleCustomCheckbox1">&nbsp;</label>
                        </div>
                      </div>
                      <div class="widget-content-left">
                      ...
                      <div class="widget-content-left me-2">
                        <div class="form-check">
                          <input type="checkbox" id="exampleCustomCheckbox4" class="form-check-input" /><label
                            class="form-check-label" for="exampleCustomCheckbox4">&nbsp;</label>
                        </div>
                      </div>
                      ...
                      <div class="widget-content-left me-2">
                        <div class="form-check">
                          <input type="checkbox" id="exampleCustomCheckbox2" class="form-check-input" /><label
                            class="form-check-label" for="exampleCustomCheckbox2">&nbsp;</label>
                        </div>
                      </div>
                      ...
                      <div class="widget-content-left me-2">
                        <div class="form-check">
                          <input type="checkbox" id="exampleCustomCheckbox3" class="form-check-input" /><label
                            class="form-check-label" for="exampleCustomCheckbox3">&nbsp;</label>
                        </div>
                      </div>
                      <div class="widget-content-left flex2">
